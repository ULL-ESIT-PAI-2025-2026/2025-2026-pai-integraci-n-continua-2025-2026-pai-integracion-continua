...
export class FunctionRenderer {
   ...
   */
  constructor(canvasElementId: string, mathXMin = -10, mathXMax = 10, mathYMin = -10, mathYMax = 10,
  ...
  /**
   * @desc Executes the rendering pipeline to draw the axes
   */
  renderCoordMap(): void {
  ...
  /**
   * @desc Executes the rendering pipeline to draw function plot, and function label on the canvas.
   */
  render(): void {
    const context = this.canvasView.getRenderingContext();
