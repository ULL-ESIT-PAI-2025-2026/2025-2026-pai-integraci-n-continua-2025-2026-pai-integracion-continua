...
Utilice como referencia para la apariencia de su aplicación el diagrama que figura en 
[esta páginaa](https://www.oecd.org/en/data/indicators/hospital-beds.html)
...
De esa página limítese a imitar los ejes de coordenadas, las leyendas de los mismos, las barras, el título de
la gráfica y las líneas horizontales que indican el número de camas.
Descarte cualquier otro elemento exterior a la gráfica que figure en esa página.
...
Es muy fácil hoy en día hallar fuentes abiertas de diverso tipo de datos. 
Elija la que más se ajuste a sus gustos o intereses.
Se valorará la originalidad de su fuente de datos: realice una mínima investigación y evite utilizar la que ya usa una mayoría de estudiantes de la
asignatura.
