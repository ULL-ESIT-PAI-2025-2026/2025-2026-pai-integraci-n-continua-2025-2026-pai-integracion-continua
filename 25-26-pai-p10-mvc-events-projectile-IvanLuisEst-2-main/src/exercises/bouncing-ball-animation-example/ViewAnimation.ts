...
export class ViewAnimation {
  ...
  //@ts-ignore: TS6133 - animationFrameId is assigned but never read, but we keep it to allow future cancellation of the animation if needed.
